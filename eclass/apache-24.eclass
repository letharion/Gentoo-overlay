...
# @DESCRIPTION:
# Based on apache-2 eclass in main tree
# This eclass handles apache-2.x ebuild functions such as LoadModule generation
# and inter-module dependency checking.

inherit autotools-utils eutils flag-o-matic multilib ssl-cert
...
DEPEND="dev-lang/perl
	...
	selinux? ( sec-policy/selinux-apache sec-policy/selinux-apache )
...
#	epatch ${FILESDIR}/apache-tools-2.4.1-Makefile.patch
	...
	AT_M4DIR=build autotools-utils_src_prepare
}
...
apache-24_src_configure() {
	...
	sed -i -e 's:apache2\.conf:httpd.conf:' "${AUTOTOOLS_BUILD_DIR}"/include/ap_config_auto.h
...
apache-24_src_install() {
	...
	dosym /usr/bin/apxs /usr/sbin/apxs2
