...
# $Header: /var/cvsroot/gentoo-x86/dev-libs/libevent/libevent-2.0.19.ebuild,v 1.8 2012/08/05 14:15:52 ryao Exp $
...
src_prepare() {
	if use hiphop; then
		epatch "${FILESDIR}/libevent-hiphop-${PV}-changes.diff"
	fi
